import { BullBear, BullBear__factory, MockV3Aggregator, MockV3Aggregator__factory } from "../../types";
...
async function getContract() {
	...
	const priceContract = MockV3Aggregator__factory.connect("0x51dcEBA0A5a13dB9448d5D7AAd64C0CD6990D7B9", signer);
	const bullBearContract = BullBear__factory.connect("0xd4Fe2485F47715C19A1E2c3b6e73E6eB62E750DC", signer);
